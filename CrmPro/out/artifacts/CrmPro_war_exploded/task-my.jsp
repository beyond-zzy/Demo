...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
    ...
    <script type="application/javascript">
        $(function(){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/task/showTaskAndEmp1',
                dataType:'json',
                success:function(resultData){
                    ...
                    $(resultData).each(function(index,item){
                        ...
                        var tr ="" +
                            ...
                            +"<td>1</td> <td>"+item.tasktitle+"</td> <td align='center'>"+item.employee.ename+"</td>" +
                            "<td align='center'>"+mystatus+"</td>" +
                            "<td align='center'>"+item.level+"</td> "
                            +"<td>"+item.starttime+"</td><td>2015-02-15</td>"
                            +"<td><a href='javascript:mydo("+item.id+",1)'>开始</a>|<a href='javascript:mydo("+item.id+",2)'>完成提交</a>|<a href='task-edit.jsp'>编辑</a> | <a href='task-look.jsp'>查看详情</a></td></tr>";
                        $("#aaa").after(tr);
                    });
                },
            });
