...
<script type="text/javascript">
        $(function(){
            $.ajax({
                ...
                success:function(resultData){
                    $(resultData).each(function(index,item){
                          var option="<option value="+item.id+","+item.companyperson+">"+item.comname+"</oiption>";
                           $("#com").append(option);
                    });
                },
            });
            ...
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/emp/showInfoByPname',
                dataType:'json',
                success:function(resultData){
                    $(resultData).each(function(index,item){
                        var option="<option value="+item.eid+">"+item.ename+"</oiption>";
                        $("#emp").append(option);
                    });
                },
            });
