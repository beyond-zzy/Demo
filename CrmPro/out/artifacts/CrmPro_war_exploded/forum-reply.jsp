...
<tr bgcolor="#E7E7E7">
	...
	<c:forEach items="${sessionScope.fe.evaluates}" var="eval">
		<tr >
			<td align="right" bgcolor="#FAFAF1" height="22">
					<span >
						<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
			...
			<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<span>评论人：${eval.employee.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span>评论时间：<fmt:formatDate value="${eval.evatime}" pattern="yyyy-MM-dd HH:mm:ss" /> </span><br>
				<span>评论内容：${eval.evacontent}</span>
				&nbsp;<span><a href="#">【回复】</a></span>
			</td>
		</tr>
	      <c:if test="${not empty eval.evaluateList}">
                 <c:forEach items="${eval.evaluateList}" var="ev">
							<tr>
									<td align="right" bgcolor="#FAFAF1" height="22">
											<span >
												<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
									...
									<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
										<span>${ev.employee.ename}&nbsp;回复了&nbsp;${eval.employee.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span>回复时间：<fmt:formatDate value="${ev.evatime}" pattern="yyyy-MM-dd HH:mm:ss" /> </span><br>
